### 07 Handling Exception, AccessDeniedException

- Agregar el manejo de la excepcion : AccessDeniedException, en GlobalHandlerException.
- Se modifico ApiError en los dto
