...
public class ProductServiceImpl implements ProductService {
    ...
    public Product createOne(SaveProduct saveProduct) {
        ...
        // No se uso CASCADE
        // Si no existe categoria al guardar el producto, marca una integridad referencial
        // Si existe categoria y modifico algun dato, no se modifica porque no se uso el CASCADE
